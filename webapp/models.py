...
class Subject(models.Model):
    ...
    describes that the uploaded file must be an animation file. This
    may be gif.

    pdf_url: If the size of the uploaded file is high contributor can
    just mention the url of the file. This field is used to mention
    the url of the file.

    video_URL: If the size of the uploading video is greater than the
    limited size, contributor can just mention the url of the
    video. This field is used to mention the url of the video.

    animation_url: If the size of the uploaded Animation is greater
    than the limited size, contributor can just mention the url of the
    animation. This field is used to mention the url of the animation.
...
class Comment(models.Model):
    ...
    submitted,at which time and on which date. This uses DateTime
    field.
